...
<p class="text-zinc-600 flex flex-col sm:flex-row items-start sm:items-center gap-2 flex-wrap">
    <span class="flex items-center gap-2">
        🚀 #1 Peerlist Hunter | Collaborator | CEO @ 
        <NuxtLink 
            to="https://catops.net/" 
            class="hover:text-zinc-800 transition-colors inline-flex items-center"
        >
        <img 
                src="https://media.licdn.com/dms/image/v2/D4E0BAQHJ_hiMESMFDQ/company-logo_100_100/B4EZhTwnvQGYAQ-/0/1753751930834/moniq_sh_logo?e=1759968000&v=beta&t=4oQcnGARN1uf61Kn-AqnVj-P4GPsb-tgCVwhO5TbbcY"
                alt="CatOps Logo" 
                class="w-5 h-5 mr-1 rounded-sm object-cover"
            />
            CatOps
